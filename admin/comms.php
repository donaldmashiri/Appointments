            ...
            <div class="col-xl-10 col-lg-9">
                <div class="card shadow mb-4">
                    ...
                    <div
                        ...
                        <h6 class="m-0 font-weight-bold text-white">Reply Feedbacks</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <table class="table table-bordered table-sm">
                            ...
                            <?php
                            $sql = "SELECT * FROM feedbacks JOIN farmers ON feedbacks.farmer_id = farmers.farmer_id
                                    ";
                                    ...
                                    <tr>
                                        ...
                                        <form method="post" action="">
                                            <td>
                                                ...
                                                <input type="text" name="comment" minlength="3" required value="<?php echo $comment ?>" placeholder="Comment :">
                                            </td>
                                            <td>
