            ...
            <div class="col-xl-10 col-lg-9">
                <div class="card shadow mb-4">
                    ...
                    <div
                        ...
                        <h6 class="m-0 font-weight-bold text-white">Feedbacks</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <table class="table table-bordered table-sm">
                            ...
                            <?php
                            $sql = "SELECT * FROM feedbacks JOIN patients ON feedbacks.pat_id = patients.pat_id
                                    ";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<p class='alert alert-danger'>No Chats yet</p>";
                            }
                            ?>
