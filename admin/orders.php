                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-sm">
                            ...
                            $sql = "SELECT * FROM orders JOIN products ON products.product_id = orders.product_id
                                JOIN farmers ON farmers.farmer_id = orders.farmer_id ORDER BY orders.order_id DESC";
                            ...
                            if ($result->num_rows > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-group font-weight-bold">
                                                <li class="list-group-item"><?php echo $first_name .' '. $last_name ?></li>
                                        ...
                                        <td>
                                            <ul class="list-group font-weight-bold list-group-horizontal-sm">
                                                <li class="list-group-item">PDT00<?php echo $product_id ?></li>
                                ...
                                echo "<p class='alert alert-danger'>No orders have been made</p>";
                            }
