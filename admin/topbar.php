    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand bg-gradient-danger d-flex align-items-center justify-content-center" href="index.php">
            <div bg-gradient-danger class="sidebar-brand-icon">
                ...
                <img src="../img/sable.png" class="rounded" width="100" height="70" alt="">
            </div>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-white-600 small">Sable Chicken Admin</span>
                            <img class="img-profile rounded-circle"
                                 src="../img/sable.png" width="50" height="50">
                        </a>
